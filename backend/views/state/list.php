            ...
            [
                ...
                'value' => function (State $state) {
                    ...
                    return Popup::factory()
                        ...
                        ->url(['/country/update', 'code' => $state->country->code]);
                },
            ...
            [
                ...
                'buttons' => [
                    ...
                    'toggle' => function ($url, State $model, $key) {
                        ...
                        return Html::a($icon, ['toggle', 'code' => $model->code], ['title' => 'Restore', 'class' => 'grid-link color-black', 'data-method' => 'post', 'data-confirm' => Yii::t('backend', 'model.restore.confirmation')]);
                    },
                ]
            ],
        ],
