...
$items = [
    'update' => ['label' => Yii::t('backend', 'common.tab.basic'), 'url' => ['/country/update', 'code' => $model->code]],
    'image' => ['label' => Yii::t('backend', 'common.tab.image'), 'url' => ['/country/image', 'code' => $model->code]],
];
