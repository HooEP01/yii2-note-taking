...
//        ],
    ...
    public function stripClean($value)
    {
        ...
        $value = $this->convertSpecialHtmlCharacters($value);
     ...
     * @return string
     */
    public function convertSpecialHtmlCharacters($value)
    {
        $flag = ENT_COMPAT | ENT_HTML5;
        $charset = strtoupper(\Yii::$app->charset);

        return html_entity_decode($value, $flag, $charset);
